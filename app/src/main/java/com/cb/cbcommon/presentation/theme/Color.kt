...
val colorGreen = Color(3, 183, 144)

val darkAppBar = Color(33, 46, 55)

val lightAppBar = Color(0xff00897B)
val lightBack = Color(0xffFBE9E7)


val colorLightGreen = Color(21, 31, 40)
